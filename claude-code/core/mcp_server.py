#!/usr/bin/env python3
"""Expose NeatMem memory search as one local coding-agent tool."""
...
TOOL_DESCRIPTION = (
    ...
    "memories, and 'mine' narrows results to memories you saved."
)
TOOL_SCHEMA = {
    "type": "object",
    "properties": {
        ...
        "top_k": {
            ...
            "minimum": 1,
            "maximum": 20,
            "description": "Maximum memories to return. Uses the configured default when omitted.",
        },
        "scope": {
            "type": "string",
            ...
            "description": (
                ...
                "shared memory plus your own memories, 'mine' narrows results to "
                "memories you saved."
            ),
        },
        "run_id": {
...
def handle_request(message: Any) -> dict[str, Any] | None:
    ...
    if method == "initialize":
        ...
        return {
            ...
            "result": {
                ...
                "serverInfo": {"name": "neatmem", "version": PLUGIN_VERSION},
            },
        }
    if method == "ping":
    ...
    if method == "tools/call":
        ...
        if params.get("name") != TOOL_NAME:
            result = _tool_response("Unknown NeatMem tool.", is_error=True)
        else:
            try:
