"""Graph memory tool schemas — verbatim copy from mem0 1.0.11 mem0/graphs/tools.py.

Copied line-for-line. Do not modify: these are the exact tool schemas mem0's
MemoryGraph sends to the LLM for entity extraction, relation extraction, and
delete judgment. Any divergence changes LLM output and breaks equivalence.
"""
