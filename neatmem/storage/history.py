...
#
# Modifications: class renamed SQLiteManager -> SQLiteHistoryManager for
# clarity (NeatMem has a separate SQLiteMessageStore for conversation
# history). No behavioral changes: table schemas, migration logic, and
# query semantics are identical so existing history.db files remain
