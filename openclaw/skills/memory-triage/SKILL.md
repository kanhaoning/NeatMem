...
name: memory-triage
description: >
  Persistent long-term memory protocol powered by NeatMem.
...
You have persistent long-term memory powered by NeatMem. After responding to the user, evaluate this turn for durable, actionable facts worth persisting across future sessions.
