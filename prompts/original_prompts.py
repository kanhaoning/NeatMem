...
User: Hi.
Assistant: Hello! I enjoy assisting you. How can I help you today?
Output: {{"facts" : []}}
...
- **Sequential Agent Actions (Numbered Steps):**
  ...
  3. **Embedded Metadata**:
     ...
     - **Errors and Challenges**: Document any error messages, exceptions, or challenges encountered along with any attempted recovery or troubleshooting.
